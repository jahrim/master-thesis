...
\lstinputlisting[language=Scala]{resources/listings/branch-observation.txt}
...
\lstinputlisting[language=Scala]{resources/listings/zip-with-round-observation.txt}
